...
from .context_builder import _connected_component, build_dependency_edges
...
def build_api_sequence_context(notebook_IR, focus_cell: int = None) -> ApiSequenceContext:
